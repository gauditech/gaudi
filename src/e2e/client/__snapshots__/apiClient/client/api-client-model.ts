...
issue: buildIssueApi(options, "issue"),
comment: buildCommentApi(options, "comment")
      }
    }
...
delete: buildDeleteFn<number, DeleteError>(options, parentPath)
  ...
  function buildCommentApi(options: ApiClientOptions, parentPath: string) {
    // endpoint types
    type GetResp = { id: number,
body: string,
issue_id: number };
